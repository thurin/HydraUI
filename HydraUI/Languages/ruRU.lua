...
L["Welcome to |cFF%sHydra|r|cFFEFFFFFUI|r Burning Crusade version |cFF%s%s|r - https://discord.gg/XefDFa6nJR"] = "Welcome to |cFF%sHydra|r|cFFEFFFFFUI|r Burning Crusade version |cFF%s%s|r - https://discord.gg/XefDFa6nJR"
