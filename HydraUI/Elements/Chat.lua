...
function Chat:CreateChatWindow()
	...
	self.TopBar = CreateFrame("Frame", "HydraUIChatFrameTop", HydraUI.UIParent)
	...
	self.BottomBar = CreateFrame("Frame", "HydraUIChatFrameBottom", HydraUI.UIParent)
...
function Chat:CreateCopyWindow()
	...
	local Window = CreateFrame("Frame", nil, HydraUI.UIParent)
