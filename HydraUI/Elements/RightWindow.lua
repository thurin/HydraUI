...
function Window:CreateSingleWindow()
	...
	self.Bottom = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.BottomFrame = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.Left = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.Right = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.Top = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.Backdrop = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.TopBar = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.OuterOutline = CreateFrame("Frame", "HydraUIMetersFrame", self.Bottom)
...
function Window:CreateDoubleWindow()
	...
	self.TopLeft = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.TopRight = CreateFrame("Frame", nil, HydraUI.UIParent)
	...
	self.BackdropMiddle = CreateFrame("Frame", nil, HydraUI.UIParent)
